...
class Homdos_ex_divisi1 extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->model('MainModel','homdos_ex_divisi1');
        // load library
        ...
        //config
        $config['base_url'] = base_url('admin/divisi1/layanan_divisi1/homdos_ex_divisi1/index');
        ...
        $data['tbl_homdos_ex'] = $this->homdos_ex_divisi1->get_data('homdos_ex', $config['per_page'], $data['start'], $data['keyword'],$data['desc'])->result();
		...
		$this->load->view('admin/divisi_view_1/homdos_ex/view_homdos_ex', $data);
	...
	public function dataView($id)
	{
		...
		$this->load->view('admin/divisi_view_1/templates_divisi1/header', $data);
		$this->load->view('admin/divisi_view_1/templates_divisi1/sidebar');
		$this->load->view('admin/divisi_view_1/homdos_ex/data_view_homdos_ex', $data);
		$this->load->view('admin/divisi_view_1/templates_divisi1/footer');
	}
	...
	public function updateDataAksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			redirect('admin/divisi1/layanan_divisi1/homdos_ex_divisi1');
		}
	}
