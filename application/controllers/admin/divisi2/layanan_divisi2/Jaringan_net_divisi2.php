...
class Jaringan_net_divisi2 extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->model('MainModel','jaringan_net_divisi2');
        // load library
        ...
        //config
        $config['base_url'] = base_url('admin/divisi2/layanan_divisi2/jaringan_net_divisi2/index');
        ...
        $data['tbl_jaringan_net'] = $this->jaringan_net_divisi2->get_data('jaringan_net', $config['per_page'], $data['start'], $data['keyword'],$data['desc'])->result();
		...
		$this->load->view('admin/divisi_view_2/jaringan_net/view_jaringan_net', $data);
	...
	public function dataView($id)
	{
		...
		$this->load->view('admin/divisi_view_2/templates_divisi2/header', $data);
		$this->load->view('admin/divisi_view_2/templates_divisi2/sidebar');
		$this->load->view('admin/divisi_view_2/jaringan_net/data_view_jaringan_net', $data);
		$this->load->view('admin/divisi_view_2/templates_divisi2/footer');
	}
	...
	public function updateDataAksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			redirect('admin/divisi2/layanan_divisi2/jaringan_net_divisi2');
		}
	}
