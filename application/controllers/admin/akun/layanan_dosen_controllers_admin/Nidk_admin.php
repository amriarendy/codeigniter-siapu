...
class Nidk_admin extends CI_Controller
{
	...
	{
		$data['title'] = "Halaman NIDK";

		$this->load->model('MainModel','Nidk_admin');
        // load library
        ...
        //config
        $config['base_url'] = base_url('admin/akun/layanan_dosen_controllers_admin/Nidk_admin/index');
        ...
        $data['tbl_nidk'] = $this->Nidk_admin->get_data('nidk', $config['per_page'], $data['start'], $data['keyword'],$data['desc'])->result();
		$this->load->view('admin/akun/templates_admin/header', $data);
		$this->load->view('admin/akun/templates_admin/sidebar');
		$this->load->view('admin/akun/layanan_dosen_view/nidk/view_nidk', $data);
	...
	public function dataView($id)
	{
		...
		$this->load->view('admin/akun/templates_admin/header', $data);
		$this->load->view('admin/akun/templates_admin/sidebar');
		$this->load->view('admin/akun/layanan_dosen_view/nidk/data_view_nidk', $data);
		$this->load->view('admin/akun/templates_admin/footer');
	}
	...
	public function updateDataAksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			redirect('admin/akun/layanan_dosen_controllers_admin/nidk_admin');
		}
	}
