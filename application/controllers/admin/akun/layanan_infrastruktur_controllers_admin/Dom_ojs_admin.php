...
class Dom_ojs_admin extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->model('MainModel','dom_ojs_admin');
        // load library
        ...
        //config
        $config['base_url'] = base_url('admin/akun/layanan_infrastruktur_controllers_admin/dom_ojs_admin/index');
        ...
        $data['tbl_dom_ojs'] = $this->dom_ojs_admin->get_data('dom_ojs', $config['per_page'], $data['start'], $data['keyword'],$data['desc'])->result();

	//	$data['tbl_dom_ojs'] = $this->pelayananModel->get_data('dom_ojs')->result();
		$this->load->view('admin/akun/templates_admin/header', $data);
		$this->load->view('admin/akun/templates_admin/sidebar');
		$this->load->view('admin/akun/layanan_infrastruktur_view/dom_ojs/view_dom_ojs', $data);
	...
	public function dataView($id)
	{
		...
		$this->load->view('admin/akun/templates_admin/header', $data);
		$this->load->view('admin/akun/templates_admin/sidebar');
		$this->load->view('admin/akun/layanan_infrastruktur_view/dom_ojs/data_view_dom_ojs', $data);
		$this->load->view('admin/akun/templates_admin/footer');
	}
	...
	public function updateDataAksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			redirect('admin/akun/layanan_infrastruktur_controllers_admin/dom_ojs_admin');
		}
	}
