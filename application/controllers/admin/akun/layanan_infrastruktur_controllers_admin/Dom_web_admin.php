...
class Dom_web_admin extends CI_Controller
{
	...
	{
		$data['title'] = "Pelayanan Pembuatan Domain Website";
		$this->load->model('MainModel','dom_web_admin');
        // load library
        ...
        //config
        $config['base_url'] = base_url('admin/akun/layanan_infrastruktur_controllers_admin/dom_web_admin/index');
        ...
        $data['tbl_dom_web'] = $this->dom_web_admin->get_data('dom_web', $config['per_page'], $data['start'], $data['keyword'],$data['desc'])->result();
	//	$data['tbl_dom_web'] = $this->pelayananModel->get_data('dom_web')->result();
		$this->load->view('admin/akun/templates_admin/header', $data);
		$this->load->view('admin/akun/templates_admin/sidebar');
		$this->load->view('admin/akun/layanan_infrastruktur_view/dom_web/view_dom_web', $data);
	...
	public function dataView($id)
	{
		...
		$this->load->view('admin/akun/templates_admin/header', $data);
		$this->load->view('admin/akun/templates_admin/sidebar');
		$this->load->view('admin/akun/layanan_infrastruktur_view/dom_web/data_view_dom_web', $data);
		$this->load->view('admin/akun/templates_admin/footer');
	}
	...
	public function updateDataAksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			redirect('admin/akun/layanan_infrastruktur_controllers_admin/dom_web_admin');
		}
	}
