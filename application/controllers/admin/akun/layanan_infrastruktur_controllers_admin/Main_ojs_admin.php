...
class Main_ojs_admin extends CI_Controller
{
	...
	{
		$data['title'] = "Pelayanan Maintence WEB/OJS";

		$this->load->model('MainModel','main_ojs_admin');
        // load library
        ...
        //config
        $config['base_url'] = base_url('admin/akun/layanan_infrastruktur_controllers_admin/main_ojs_admin/index');
        ...
        $data['tbl_main_ojs'] = $this->main_ojs_admin->get_data('main_ojs', $config['per_page'], $data['start'], $data['keyword'],$data['desc'])->result();
	...
	//	$data['tbl_main_ojs'] = $this->pelayananModel->get_data('main_ojs')->result();
		...
		$this->load->view('admin/akun/layanan_infrastruktur_view/main_ojs/view_main_ojs', $data);
	...
	public function dataView($id)
	{
		...
		$this->load->view('admin/akun/templates_admin/header', $data);
		$this->load->view('admin/akun/templates_admin/sidebar');
		$this->load->view('admin/akun/layanan_infrastruktur_view/main_ojs/data_view_main_ojs', $data);
		$this->load->view('admin/akun/templates_admin/footer');
	}
	...
	public function updateDataAksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$file = array(
                'berkas_main_ojs' => $berkas_main_ojs,
            );
			$where = array(
				'id_main_ojs' => $id
			);
			...
			redirect('admin/akun/layanan_infrastruktur_controllers_admin/main_ojs_admin');
		}
	}
