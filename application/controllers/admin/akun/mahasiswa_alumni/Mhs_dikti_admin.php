...
class Mhs_dikti_admin extends CI_Controller
{
	...
	{
		$data['title'] = "Pelayanan Ubah PD Dikti Mahasiswa";

		$this->load->model('MainModel','mhs_dikti_admin');
        // load library
        ...
        //config
        $config['base_url'] = base_url('admin/akun/mahasiswa_alumni/mhs_dikti_admin/index');
        ...
        $data['tbl_mhs_dikti'] = $this->mhs_dikti_admin->get_data('mhs_dikti', $config['per_page'], $data['start'], $data['keyword'],$data['desc'])->result();

	//	$data['tbl_mhs_dikti'] = $this->pelayananModel->get_data('mhs_dikti')->result();
		$this->load->view('admin/akun/templates_admin/header', $data);
		$this->load->view('admin/akun/templates_admin/sidebar');
		$this->load->view('admin/akun/mahasiswa_alumni_view/mhs_dikti/view_mhs_dikti', $data);
	...
	public function dataView($id)
	{
		...
		$this->load->view('admin/akun/templates_admin/header', $data);
		$this->load->view('admin/akun/templates_admin/sidebar');
		$this->load->view('admin/akun/mahasiswa_alumni_view/mhs_dikti/data_view_mhs_dikti', $data);
		$this->load->view('admin/akun/templates_admin/footer');
	}
	...
	public function updateDataAksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			redirect('admin/akun/mahasiswa_alumni/mhs_dikti_admin');
		}
	}
