...
class Ujian_ti_admin extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->model('MainModel','ujian_ti_admin');
        // load library
        ...
        //config
        $config['base_url'] = base_url('admin/akun/mahasiswa_alumni/ujian_ti_admin/index');
        ...
        $data['tbl_ujian_ti'] = $this->ujian_ti_admin->get_data('ujian_ti', $config['per_page'], $data['start'], $data['keyword'],$data['desc'])->result();
	...
	//	$data['tbl_ujian_ti'] = $this->pelayananModel->get_data('ujian_ti')->result();
		...
		$this->load->view('admin/akun/mahasiswa_alumni_view/ujian_ti/view_ujian_ti', $data);
	...
	public function dataView($id)
	{
		...
		$this->load->view('admin/akun/templates_admin/header', $data);
		$this->load->view('admin/akun/templates_admin/sidebar');
		$this->load->view('admin/akun/mahasiswa_alumni_view/ujian_ti/data_view_ujian_ti', $data);
		$this->load->view('admin/akun/templates_admin/footer');
	}
	...
	public function updateDataAksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			redirect('admin/akun/mahasiswa_alumni/ujian_ti_admin');
		}
	}
