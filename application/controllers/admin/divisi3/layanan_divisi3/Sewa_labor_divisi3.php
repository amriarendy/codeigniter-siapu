...
class Sewa_labor_divisi3 extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->model('MainModel','sewa_labor_divisi3');
        // load library
        ...
        //config
        $config['base_url'] = base_url('admin/divisi3/layanan_divisi3/sewa_labor_divisi3/index');
        ...
        $data['tbl_sewa_labor'] = $this->sewa_labor_divisi3->get_data('sewa_labor', $config['per_page'], $data['start'], $data['keyword'],$data['desc'])->result();
	//	$data['tbl_sewa_labor'] = $this->pelayananModel->get_data('sewa_labor')->result();
		...
		$this->load->view('admin/divisi_view_3/sewa_labor/view_sewa_labor', $data);
	...
	public function dataView($id)
	{
		...
		$this->load->view('admin/divisi_view_3/templates_divisi3/header', $data);
		$this->load->view('admin/divisi_view_3/templates_divisi3/sidebar');
		$this->load->view('admin/divisi_view_3/sewa_labor/data_view_sewa_labor', $data);
		$this->load->view('admin/divisi_view_3/templates_divisi3/footer');
	}
	...
	public function updateDataAksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			redirect('admin/divisi3/layanan_divisi3/sewa_labor_divisi3');
		}
	}
