<?php
class CekPublic extends CI_Controller
{
	public function index()
	{
		...
		$this->load->view('view_cek/cek_public/list_public', $data);
	...
	public function updatePublic($id)
	{
		...
		$this->load->view('user/templates_user/auth_header');
		$this->load->view('view_cek/cek_public/update_public', $data);
		$this->load->view('user/templates_user/auth_footer');
	}
	public function updatePublicAksi()
	{
		$this->_rules();

		if ($this->form_validation->run() == FALSE) {
			$this->updatePublic($this->input->post('id'));
		} else {
