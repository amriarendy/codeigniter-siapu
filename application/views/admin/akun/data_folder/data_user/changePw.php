<div class="container-fluid">
    ...
    <div class="card" style="width:50%">
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo base_url('admin/akun/DataUser/gantiPasswordAksi') ?>">
                    <input type="hidden" name="id" class="form-control" value="<?php echo $u->id ?>">
                <div class="form-group">
                    <label>Nama Akun</label>
                    <input type="text" name="passBaru" class="form-control" value="<?php echo $u->name_user ?>" readonly>
                    <?php echo form_error('passBaru', '<small class="text-danger pl-3">', '</small>') ?>
                </div>
                    <div class="form-group">
                <label>Username Akun</label>
                    <input type="text" name="passBaru" class="form-control" value="<?php echo $u->username ?>" readonly>
                    <?php echo form_error('passBaru', '<small class="text-danger pl-3">', '</small>') ?>
                </div>
                <div class="form-group">
