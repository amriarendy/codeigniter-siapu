<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-md-5">  
                    <form action="<?= base_url('admin/akun/mahasiswa_alumni/ujian_ti_admin'); ?>" method="POST">
            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('admin/akun/mahasiswa_alumni/ujian_ti_admin/dataView/'. $ujian_ti->id_ujian_ti) ?>" class="badge badge-primary">Lihat</a>
                            <a onclick="return confirm('Yakin Hapus?')" href="<?php echo base_url('admin/akun/mahasiswa_alumni/ujian_ti_admin/deleteData/'. $ujian_ti->id_ujian_ti) ?>" class="badge badge-danger">delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
