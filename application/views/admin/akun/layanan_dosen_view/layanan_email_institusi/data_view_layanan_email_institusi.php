<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <form method="POST" action="<?php echo base_url('admin/akun/layanan_dosen_controllers_admin/LayananEmailInstitusi_admin/updateDataAksi')?>" enctype="multipart/form-data">
        <div class="card-body mx-10">
            ...
            <div class="col-md-12">
                <table class="table table-striped table-hover">
                    ...
                    <input type="hidden" name="id_lei" value="<?php echo $lei->id_lei ?>"></td>
                    <tr>
                        <td>ID User</td>
                        <td>:</td>
                    ...
                    <!-- <tr>
                        <td>ID Divisi</td>
                        <td>:</td>
                        <td><?php echo $lei->akses_id ?></td>
                    </tr>
                    <tr>
                        <td>Nama Divisi</td>
                        <td>:</td>
                        <td><?php echo $lei->nama_akses ?></td>
                    </tr>
                    <tr>
                        <td>ID Layanan</td>
                        <td>:</td>
                        <td><?php echo $lei->layanan_id ?></td>
                    </tr>
                    <tr>
                        <td>Kategori Layanan</td>
                        <td>:</td>
                        <td><?php echo $lei->nama_layanan ?></td>
                    </tr> -->
                    <tr>
                        <td>Status</td>
                        <td>:</td>
                        <td>
                            <select type="text" name="status_lei" class="form-control">
                                <option value="<?php echo $lei->status_lei ?>">
                                <?php if($lei -> status_lei == 'Y'){ ?><a>Selesai</a> <?php }
                                else if($lei -> status_lei == 'P'){ ?> <a>Proses</a><?php }
                                else if($lei -> status_lei == 'U'){ ?> <a>Berkas Belum Lengkap!</a><?php } ?></option>
                                <option value="U">Berkas Belum Lengkap!</option>
                                <option value="P">Proses</option>
                                <option value="Y">Selesai</option>
                                <?php echo form_error('status_lei','<div class="text-small text-danger"></div>'); ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <?php
                        if($lei -> file_lei)
                            { ?><a href="<?php echo base_url() . 'assets/file/berkas_user/' . $lei->file_lei ?>"><i class="btn btn-sm btn btn-success">Download Berkas</i></a> <?php 
                        }else if($lei -> file_lei == null){ ?>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><input type="file" name="berkas_lei" class="form-control"></td>
