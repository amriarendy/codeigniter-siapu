            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('admin/akun/layanan_dosen_controllers_admin/homdos_in_admin/dataView/'. $homdos_in->id_homdos_in) ?>" class="badge badge-primary">Lihat</a>
                            <a onclick="return confirm('Yakin Hapus?')" href="<?php echo base_url('admin/akun/layanan_dosen_controllers_admin/homdos_in_admin/deleteData/'. $homdos_in->id_homdos_in) ?>" class="badge badge-danger">delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
