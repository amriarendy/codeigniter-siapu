<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <form method="POST" action="<?php echo base_url('admin/akun/layanan_dosen_controllers_admin/nup_admin/updateDataAksi')?>" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td>Nama Divisi</td>
                        <td>:</td>
                        <td><?php echo $nup->nama_akses ?></td>
                    </tr>
                    <tr>
                        <td>ID Layanan</td>
                        <td>:</td>
                        <td><?php echo $nup->layanan_id ?></td>
                    </tr>
                    <tr>
                        <td>Kategori Layanan</td>
                        <td>:</td>
                        <td><?php echo $nup->nama_layanan ?></td>
                    </tr> -->
                    <tr>
                        <td>Status</td>
                        <td>:</td>
