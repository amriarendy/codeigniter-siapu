<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <form method="POST" action="<?php echo base_url('admin/akun/layanan_dosen_controllers_admin/nidn_admin/updateDataAksi')?>" enctype="multipart/form-data">
        <div class="card-body mx-10">
            ...
            <div class="col-md-12">
                <table class="table table-striped table-hover">
                    ...
                    <input type="hidden" name="id_nidn" value="<?php echo $nidn->id_nidn ?>"></td>
                    <tr>
                        <td>ID User</td>
                        <td>:</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <select type="text" name="status_nidn" class="form-control">
                                <option value="<?php echo $nidn->status_nidn ?>">
                                <?php if($nidn -> status_nidn == 'Y'){ ?><a>Selesai</a> <?php }
                                else if($nidn -> status_nidn == 'P'){ ?> <a>Proses</a><?php }
                                else if($nidn -> status_nidn == 'U'){ ?> <a>Berkas Belum Lengkap!</a><?php } ?></option>
                                <option value="U">Berkas Belum Lengkap!</option>
                                <option value="P">Proses</option>
                                <option value="Y">Selesai</option>
                                <?php echo form_error('status_nidn','<div class="text-small text-danger"></div>'); ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <?php
                        if($nidn -> file_nidn)
                            { ?><a href="<?php echo base_url() . 'assets/file/berkas_user/' . $nidn->file_nidn ?>"><i class="btn btn-sm btn btn-success">Download Berkas</i></a> <?php 
                        }else if($nidn -> file_nidn == null){ ?>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><input type="file" name="berkas_nidn" class="form-control"></td>
