            ...
            <div class="col-md-12">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <select type="text" name="status_dom_ojs" class="form-control">
                                <option value="<?php echo $dom_ojs->status_dom_ojs ?>">
                                <?php if($dom_ojs -> status_dom_ojs == 'Y'){ ?><a>Selesai</a> <?php }
                                else if($dom_ojs -> status_dom_ojs == 'P'){ ?> <a>Proses</a><?php }
                                else if($dom_ojs -> status_dom_ojs == 'U'){ ?> <a>Berkas Belum Lengkap!</a><?php } ?></option>
                                <option value="U">Berkas Belum Lengkap!</option>
                                <option value="P">Proses</option>
                                <option value="Y">Selesai</option>
                                <?php echo form_error('status_dom_ojs','<div class="text-small text-danger"></div>'); ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
