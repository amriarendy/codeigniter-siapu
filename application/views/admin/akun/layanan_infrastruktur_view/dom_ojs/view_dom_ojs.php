<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
           ...
           <div class="row">
                <div class="col-md-5">  
                    <form action="<?= base_url('admin/akun/layanan_dosen_controllers_admin/dom_ojs_admin'); ?>" method="POST">
            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('admin/akun/layanan_infrastruktur_controllers_admin/dom_ojs_admin/dataView/'. $dom_ojs->id_dom_ojs) ?>" class="badge badge-primary">Lihat</a>
                            <a onclick="return confirm('Yakin Hapus?')" href="<?php echo base_url('admin/akun/layanan_infrastruktur_controllers_admin/dom_ojs_admin/deleteData/'. $dom_ojs->id_dom_ojs) ?>" class="badge badge-danger">delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
