            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('admin/akun/layanan_infrastruktur_controllers_admin/jaringan_net_admin/dataView/'. $jaringan_net->id_jaringan_net) ?>" class="badge badge-primary">Lihat</a>
                            <a onclick="return confirm('Yakin Hapus?')" href="<?php echo base_url('admin/akun/layanan_infrastruktur_controllers_admin/jaringan_net_admin/deleteData/'. $jaringan_net->id_jaringan_net) ?>" class="badge badge-danger">delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
