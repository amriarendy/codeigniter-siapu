<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
           ...
           <div class="row">
                <div class="col-md-5">  
                    <form action="<?= base_url('admin/divisi1/layanan_divisi1/mhs_dikti_divisi1'); ?>" method="POST">
            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('admin/akun/layanan_infrastruktur_controllers_admin/mhs_dikti_admin/dataView/'. $mhs_dikti->id_mhs_dikti) ?>" class="badge badge-primary">Lihat</a>
                            <a onclick="return confirm('Yakin Hapus?')" href="<?php echo base_url('admin/akun/layanan_infrastruktur_controllers_admin/mhs_dikti_admin/deleteData/'. $mhs_dikti->id_mhs_dikti) ?>" class="badge badge-danger">delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
