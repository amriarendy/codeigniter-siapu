<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <form method="POST" action="<?php echo base_url('admin/akun/layanan_infrastruktur_controllers_admin/mhs_dikti_admin/updateDataAksi')?>" enctype="multipart/form-data">
