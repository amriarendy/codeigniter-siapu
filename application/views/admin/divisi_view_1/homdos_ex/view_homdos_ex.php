<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
           ...
           <div class="row">
                <div class="col-md-5">  
                    <form action="<?= base_url('admin/divisi1/layanan_divisi1/homdos_ex_divisi1'); ?>" method="POST">
            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('admin/divisi1/layanan_divisi1/homdos_ex_divisi1/dataView/'. $homdos_ex->id_homdos_ex) ?>" class="badge badge-primary">Lihat</a>
                            <a onclick="return confirm('Yakin Hapus?')" href="<?php echo base_url('admin/divisi1/layanan_divisi1/homdos_ex_divisi1/deleteData/'. $homdos_ex->id_homdos_ex) ?>" class="badge badge-danger">delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
