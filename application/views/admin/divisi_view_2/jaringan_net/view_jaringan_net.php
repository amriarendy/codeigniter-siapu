<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
           ...
           <div class="row">
                <div class="col-md-5"> 
                    <form action="<?= base_url('admin/divisi2/layanan_divisi2/jaringan_net_divisi2'); ?>" method="POST">
            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('admin/divisi2/layanan_divisi2/jaringan_net_divisi2/dataView/'. $jaringan_net->id_jaringan_net) ?>" class="badge badge-primary">Lihat</a>
                            <a onclick="return confirm('Yakin Hapus?')" href="<?php echo base_url('admin/divisi2/layanan_divisi2/jaringan_net_divisi2/deleteData/'. $jaringan_net->id_jaringan_net) ?>" class="badge badge-danger">delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
