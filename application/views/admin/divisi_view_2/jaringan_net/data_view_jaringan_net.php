<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <form method="POST" action="<?php echo base_url('admin/divisi2/layanan_divisi2/jaringan_net_divisi2/updateDataAksi')?>" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <td>
                            <select type="text" name="status_jaringan_net" class="form-control">
                                <option value="<?php echo $jaringan_net->status_jaringan_net ?>">
