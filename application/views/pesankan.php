<div class="container-fluid">
    ...
    <div class="card" style="width:50%">
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo base_url('user/mahasiswa/ChangeMahasiswa/gantiPasswordAksi') ?>">
                <input type="hidden" name="id" class="form-control" value="<?php echo $tu->id?>">
                <div class="form-group">
                    <label>Password Baru</label>
                    <input type="type" name="passBaru" class="form-control">
                    <?php echo form_error('passBaru', '<small class="text-danger pl-3">', '</small>') ?>
                </div>
                <div class="form-group">
                    <label>Ulangi Password Baru</label>
                    <input type="type" name="ulangPass" class="form-control">
