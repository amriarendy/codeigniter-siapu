						...
						<div class="row">
							<div class="col-lg-12">
								<div class="p-5">
								    ...
								    <div class="row">
								        <div class="col-md-5">
								            <a class="btn btn-sm btn-success mb-3" href="<?php echo base_url('cek_aktived/CekDosen/updateDosen/'. $u->id) ?>"><i class="fas fa-edit" align="center"></i> Edit Data</a>
								        </div>
								        <div class="col-md-12">
								            ...
								            <table class="font-weight-bold table table-striped">
								                ...
								                <tr class="alert-warning">
								                    ...
								                    <td>
								                    	<?php
									                        if($u -> notice)
									                            { ?><div class="alert-danger" role="alert" align="center">"<?php echo $u->notice ?>"</div> <?php 
									                        }else if($u -> notice == null){ ?>
									                            <label  class="">...</label>
									                    <?php } ?>
								...
								<p class="text-danger">Note : Mohon untuk mengisi data dengan benar dan tidak salah, tunggu admin untuk mengaktifkan akun anda</p>
								</div>
							</div>
						</div>
					</div>
