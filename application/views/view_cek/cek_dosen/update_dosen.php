									...
									<div class="col-md-5">
                                    	...
                                    	<div class="card font-weight-bold" style="width: auto; margin-bottom: 100px;">
                                    		<div class="card-body">
                                    			...
                                    			<form method="POST" action="<?php echo base_url('cek_aktived/CekDosen/updateDosenAksi') ?>" enctype="multipart/form-data">
                                    				...
                                    				<div class="form-group">
                                    					...
                                    					<select name="hak_layanan" class="form-control">
                                    						<option value="<?php echo $tu->hak_layanan?>">
                                                                ...
                                                                else if($tu -> hak_layanan == '3'){ ?>Public<?php } ?></option>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Semester</label>
                                                         <select name="jenis_dosen" class="form-control">
                                                            <option value="<?php echo $tu->jenis_dosen?>"><?php echo $tu->jenis_dosen?></option>
