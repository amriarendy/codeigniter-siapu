						...
						<div class="row">
							<div class="col-lg-12">
								<div class="p-5">
								    ...
								    <div class="row">
								        <div class="col-md-5">
								            <a class="btn btn-sm btn-success mb-3" href="<?php echo base_url('cek_aktived/CekPublic/updatePublic/'. $u->id) ?>"><i class="fas fa-edit" align="center"></i> Edit Data</a>
								        </div>
								        <div class="col-md-12">
								            ...
								            <table class="font-weight-bold table table-striped">
								                ...
								                <tr>
								                    ...
								                    <td>:</td>
								                    <td>
								                    	<?php if($u -> is_active == '0'){ ?><small class="badge badge-warning">Akun Belum Aktif, unggu Konfirmasi Admin</small> <?php }
