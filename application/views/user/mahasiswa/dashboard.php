<div class="container-fluid">
    ...
    <div class="alert alert-success font-weight-bold mb-4 col-lg-8">
        Selamat Datang Anda Login Sebagai Mahasiswa
    </div>
...
<?php foreach ($tbl_user as $u) : ?>
    ...
    <div class="row no-gutters ">
        ...
        <a class="btn btn-sm btn-success mb-3" href="<?php echo base_url('user/mahasiswa/dashboard/dataview/'. $u->id) ?>"><i class="fas fa-edit"></i> Edit Data</a>
        </div>
    </div>
    </div>
<?php endforeach; ?>
