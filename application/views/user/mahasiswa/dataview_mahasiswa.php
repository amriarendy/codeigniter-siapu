<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="col-md-12">
            <form method="POST" action="<?php echo base_url('user/mahasiswa/dashboard/updateDataAksi') ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Prodi</label>
                    <input type="text" class="form-control" name="prodi" value="<?php echo $u->prodi?>">
                    <?= form_error('prodi', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>
                <div class="form-group">
                    <label>Kartu KTM</label>
                    <div>
