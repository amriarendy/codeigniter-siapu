<div class="container-fluid">
    ...
    <div class="card" style="width: 60%; margin-bottom: 100px;">
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo base_url('user/dosen/layanan_user_dosen/LayananEmailInstitusi_dosen/tambahDataAksi')?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>tanggal</label>
                    <input type="text" name="time_stamp_lei" class="form-control" value="<?php echo date("d F Y");?>" readonly>
                    
                </div>

                    <input type="hidden" name="status_lei" class="form-control" value="P">

                <div class="form-group">
                    <label>Layanan</label>
                    <select name="title_lei" class="form-control">
                        <option value="Pembuatan Email Baru">Pembuatan Email Baru</option>
                        <option value="Setel Ulang Sandi/Password">Setel Ulang Sandi/Password</option>
                ...
                <div class="form-group">
                    ...
                    <textarea name="desc_lei" class="form-control"></textarea>
                    <?= form_error('desc_lei', '<small class="text-danger pl-3">', '</small>'); ?> 
                </div>
