    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="col-md-12">
                <table class="table table-striped table-hover">
                        ...
                        <input type="hidden" name="id_main_ojs" value="<?php echo $main_ojs->id_main_ojs ?>">
                    <tr>
                        <td>ID User</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Nama Admin</td>
                        <td>:</td>
                        <td><?php echo $main_ojs->name_admin ?></td>
                    </tr>

                    <tr>
                        <td>Berkas Anda</td>
                        <td>:</td>
                        <td><a style="color: blue;"><?php echo $main_ojs->file_main_ojs ?></a></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                        <?php
                        if($main_ojs -> berkas_main_ojs)
                            { ?><a href="<?php echo base_url() . 'assets/file/berkas_admin/' . $main_ojs->berkas_main_ojs ?>"><i class="btn btn-sm btn btn-success">Download Berkas</i></a> <?php 
                        }else if($main_ojs -> berkas_main_ojs == null){ ?>
