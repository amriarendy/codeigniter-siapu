<div class="container-fluid">
    ...
    <div class="card" style="width: 60%; margin-bottom: 100px;">
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo base_url('user/dosen/layanan_user_dosen/main_ojs_dosen/tambahDataAksi')?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>tanggal</label>
                    <input type="text" name="time_stamp_main_ojs" class="form-control" value="<?php echo date("d F Y");?>" readonly>
                    
                </div>

                    <input type="hidden" name="status_main_ojs" class="form-control" value="P">

                <div class="form-group">
                    <label>Title</label>
                    <input type="text" name="title_main_ojs" class="form-control" value="Pengajuan Buat Domain OJS" readonly>
                </div>

                <div class="form-group">
                    <label>Deskripsi</label>
                    <textarea name="desc_main_ojs" class="form-control"></textarea>
                    <?= form_error('desc_main_ojs', '<small class="text-danger pl-3">', '</small>'); ?> 
                </div>

                <div class="form-group">
                        <label>Berkas</label>
                        <input type="file" name="file_main_ojs" class="form-control"> 
