<div class="container-fluid">
    ...
    <div class="card" style="width: 60%; margin-bottom: 100px;">
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo base_url('user/dosen/layanan_user_dosen/nidn_dosen/tambahDataAksi')?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>tanggal</label>
                    <input type="text" name="time_stamp_nidn" class="form-control" value="<?php echo date("d F Y");?>" readonly>
                    
                </div>

                    <input type="hidden" name="status_nidn" class="form-control" value="P">

                <div class="form-group">
                    <label>Title</label>
                    <input type="text" name="title_nidn" class="form-control" value="Pengajuan NIDN" readonly>
                </div>

                <div class="form-group">
                    <label>Deskripsi</label>
                    <textarea name="desc_nidn" class="form-control"></textarea>
                    <?= form_error('desc_nidn', '<small class="text-danger pl-3">', '</small>'); ?> 
                </div>

                <div class="form-group">
                        <label>Berkas</label>
                        <input type="file" name="file_nidn" class="form-control"> 
