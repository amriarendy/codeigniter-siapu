<div class="container-fluid">
    ...
    <div class="card" style="width: 60%; margin-bottom: 100px;">
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo base_url('user/dosen/layanan_user_dosen/labor_dosen/tambahDataAksi')?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>tanggal</label>
                    <input type="text" name="time_stamp_labor" class="form-control" value="<?php echo date("d F Y");?>" readonly>
                    
                </div>

                    <input type="hidden" name="status_labor" class="form-control" value="P">

                <div class="form-group">
                    <label>Title</label>
                    <input type="text" name="title_labor" class="form-control" value="Pengajuan Pengajuan Ruang Labor" readonly>
                </div>

                <div class="form-group">
                    <label>Deskripsi</label>
                    <textarea name="desc_labor" class="form-control"></textarea>
                    <?= form_error('desc_labor', '<small class="text-danger pl-3">', '</small>'); ?> 
                </div>

                <div class="form-group">
                        <label>Berkas</label>
                        <input type="file" name="file_labor" class="form-control"> 
